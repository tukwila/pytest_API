 ...
 *******************************************************************************
 * @file   vehicleData_40009.h
 * @brief  Head file of vehicle data structures and interface for version 0x40009.
 *******************************************************************************
 */

#ifndef VEHICLE_DATA_40009_H
#define VEHICLE_DATA_40009_H
#include <string>
#include <vector>
#include <map>
#include <list>
...
namespace vdb_40009
{
const uint32_t DB_VERSION_VEHICLE_FILE = RDB_VERSION_MAIN + 9;
...
template<>
struct VehicleDBData<rdbSerialization::vdb_40009::DB_VERSION_VEHICLE_FILE>
{
    using DATA_TYPE = rdbSerialization::vdb_40009::VehicleDivisionDetail_t;
