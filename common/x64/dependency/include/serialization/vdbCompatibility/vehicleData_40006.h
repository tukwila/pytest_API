 ...
 *******************************************************************************
 * @file   vehicleData_40006.h
 * @brief  Head file of vehicle data structures and interface for version 0x40006.
 *******************************************************************************
 */

#ifndef VEHICLE_DATA_40006_H
#define VEHICLE_DATA_40006_H
#include <string>
#include <vector>
#include <map>
#include <list>
...
namespace vdb_40006
{
const uint32_t DB_VERSION_VEHICLE_FILE = 6;
...
struct VehicleMapPoint_t  // with 3D descriptor
{
    ...
    VehicleMapPoint_t() : nID(0), confidence(.0) {}
};
...
{
    uint64_t                       dbID;     //generate by database;
...
template<>
struct VehicleDBData<rdbSerialization::vdb_40006::DB_VERSION_VEHICLE_FILE>
{
    using DATA_TYPE = rdbSerialization::vdb_40006::VehicleDivisionDetail_t;
