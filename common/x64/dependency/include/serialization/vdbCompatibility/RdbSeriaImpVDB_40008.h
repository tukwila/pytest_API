...
#ifndef RDB_SERIA_IMP_VDB_40008_H
#define RDB_SERIA_IMP_VDB_40008_H
...
void serialize(Seria &seria, vdb_40008::VehicleMapPoint_t &obj)
{
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40008::VehicleKeyFrame_t &obj)
{
    seria & obj.nID
          & obj.relativeGPS
          & obj.quaternion
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40008::BatchInfo_t &obj)
{
    seria & obj.rtvname;
}
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40008::VehicleReference_t &obj)
{
    CodingVector<VECTOR_CODE_TYPE_2BYTE_E, vdb_40008::VehicleKeyFrame_t> cvecKfs(obj.vecKfs);
    CodingVector<VECTOR_CODE_TYPE_3BYTE_E, vdb_40008::VehicleMapPoint_t> cvecMps(obj.vecMps);
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40008::VehicleNode_t &obj)
{
    seria & obj.dbID
          & obj.coordinate;
}
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40008::GpsItem_t &obj)
{
    seria & obj.quality
          & obj.gps;
}
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40008::VehicleDivision_t &obj)
{
    CodingVector<VECTOR_CODE_TYPE_2BYTE_E, vdb_40008::GpsItem_t> cvecGPS(obj.vecGPSTrajectory);
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40008::VehicleDivisionDetail_t &obj)
{
    CodingVector<VECTOR_CODE_TYPE_1BYTE_E, std::shared_ptr<vdb_40008::VehicleReference_t>> cvecRef(obj.spReferences);
    ...
    if (vdb_40008::VEHICLE_DIV_MODE_NO_REF_E != obj.eMode)
    {
        CodingVector<VECTOR_CODE_TYPE_1BYTE_E, std::shared_ptr<vdb_40008::VehicleReference_t>> cvecRef(obj.spReferences);
...
#endif //RDB_SERIA_IMP_VDB_40008_H
