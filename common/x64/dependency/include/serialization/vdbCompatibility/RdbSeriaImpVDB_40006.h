...
#ifndef RDB_SERIA_IMP_VDB_40006_H
#define RDB_SERIA_IMP_VDB_40006_H
...
void serialize(Seria &seria, vdb_40006::VehicleMapPoint_t &obj)
{
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40006::VehicleKeyFrame_t &obj)
{
    seria & obj.nID
          & obj.coordinate
          & obj.quaternion
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40006::BatchInfo_t &obj)
{
    seria & obj.rtvname;
}
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40006::VehicleReference_t &obj)
{
    CodingVector<VECTOR_CODE_TYPE_2BYTE_E, vdb_40006::VehicleKeyFrame_t> cvecKfs(obj.vecKfs);
    CodingVector<VECTOR_CODE_TYPE_3BYTE_E, vdb_40006::VehicleMapPoint_t> cvecMps(obj.vecMps);
...
void serialize(RdbV2SBinSerializer &seria, std::shared_ptr<vdb_40006::VehicleReference_t> &obj);
void serialize(RdbV2SBinDeserializer &seria, std::shared_ptr<vdb_40006::VehicleReference_t> &obj);
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40006::VehicleNode_t &obj)
{
    seria & obj.dbID
          & obj.coordinate;
}
 ...
 */
template<typename Seria>
void serialize(Seria &seria, vdb_40006::VehicleDivision_t &obj)
{
    CodingVector<VECTOR_CODE_TYPE_2BYTE_E, Point3d_t> cvecGPS(obj.vecGPSTrajectory);
 ...
 *******************************************************************************
 */
void serialize(RdbV2SBinSerializer &seria, vdb_40006::VehicleDivisionDetail_t &obj);

void serialize(RdbV2SBinDeserializer &seria, vdb_40006::VehicleDivisionDetail_t &obj);
...
#endif //RDB_SERIA_IMP_VDB_40006_H
